...
const ecosystemLinks = [
  ...
  },
  {
  ...
  },
   {
    ...
    description: "Funding opportunities for developers and teams looking to build on or with the Exnus protocol.",
    href: "#",
    icon: (
        <svg className="w-10 h-10 text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
  },
];
