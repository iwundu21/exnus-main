...
const getQuarterStatus = (quarter: string) => {
    ...
    if (year < currentYear || (year === currentYear && quarterNum < currentQuarter)) {
        return "complete";
    }
    if (year === currentYear && quarterNum === currentQuarter) {
        return "current";
    }
    return "future";
}
    ...
    >
      <div className="relative z-10">
        <div className="header-card text-center mb-12">
          <ScrollReveal>
          <h2 className="text-3xl md:text-4xl font-bold gradient-text">Our Roadmap</h2>
