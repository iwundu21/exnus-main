...
import { getComments, addComment, type Comment as CommentType, type NewsPost } from "@/app/admin/actions";
...
export function NewsDetailClient({ post, initialComments }: { post: NewsPost, initialComments: CommentType[] }) {
