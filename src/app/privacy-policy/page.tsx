      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal delay={200}>
          <div className="prose max-w-none prose-invert text-foreground/80 space-y-6">
            ...
            <h2 className="text-2xl font-bold gradient-text">1. Collection of Your Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">2. Use of Your Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">3. Disclosure of Your Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">4. Security of Your Information</h2>
            <p>
              We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.
            </p>

            <h2 className="text-2xl font-bold gradient-text">5. Policy for Children</h2>
            <p>
              We do not knowingly solicit information from or market to children under the age of 13. If you become aware of any data we have collected from children under age 13, please contact us using the contact information provided below.
            </p>

            <h2 className="text-2xl font-bold gradient-text">6. Changes to This Privacy Policy</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">7. Contact Us</h2>
            <p>
