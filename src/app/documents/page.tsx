            ...
            return (
                <div className="prose max-w-none prose-invert text-foreground/80">
                    ...
                    <div className="not-prose my-8">
                      <div className="overflow-hidden p-0 md:p-4 rounded-lg">
                          <ArchitectureDiagram />
                      </div>
            ...
            return (
                <div className="prose max-w-none prose-invert text-foreground/80">
                    ...
                    <ul className="list-disc pl-6 space-y-2 mt-6">
                        <li><strong>Staking Rewards (68.12%):</strong> 1.703 Billion Tokens. The largest portion of tokens is set aside for staking rewards, encouraging token holders to participate in network validation and governance while earning additional tokens.</li>
                        ...
                        <li><strong>Broader Ecosystem Grant (3.28%):</strong> 82 Million Tokens. This allocation is designated for grants to support and expand the broader ecosystem, fostering innovation and growth.</li>
                    ...
                    <p>
                        The 1.703 billion tokens allocated for staking rewards are subject to a structured vesting schedule to ensure the long-term health and stability of the network. The rewards will be distributed linearly over a period of ten years (120 months) starting from the Token Generation Event (TGE).
                    </p>
                    <div className="not-prose my-8">
                        <div className="overflow-hidden p-6 md:p-8 rounded-lg">
                    ...
                    <ul className="list-disc pl-6 space-y-2 mt-4">
                        ...
                        <li><strong>Monthly Distribution:</strong> Approximately 14.19 million tokens will be released to the staking rewards pool each month.</li>
                    </ul>
                    <p className="mt-4">
