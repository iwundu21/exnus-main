      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal delay={200}>
          <div className="prose max-w-none prose-invert text-foreground/80 space-y-6">
            <h2 className="text-2xl font-bold gradient-text">1. Agreement to Terms</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">2. Use License</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">5. Accuracy of Materials</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">6. Governing Law</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">7. Changes to Terms</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold gradient-text">8. Contact Us</h2>
            <p>
